...
<head>
    <meta charset="UTF-8">
    <title>Return Orders - Admin Panel</title>
    <style>
        body {
        ...
        <table>
            ...
            <%
                try {
                    ...
                    String subject = "Your Order #" + orderId + " has been Successfully Returned.";
                    String message = "Dear customer, your order #"+orderId+" was returned to us. Please contact us to arrange re-delivery or for more help 📦↩📞 Thank you for choosing us.";
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if (orderId != null) {
            try {
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/cgp", "root", "3323");
                PreparedStatement pstmt = con.prepareStatement("UPDATE oders SET status = 'FinishedReturned' WHERE oder_id = ?");
