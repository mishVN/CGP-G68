    ...
    <%
        if (request.getMethod().equalsIgnoreCase("post")) {
            ...
            try {
                ...
                String checkQuery = "SELECT * FROM user_account WHERE email=? AND password=?";
                ...
                if (rs.next()) {
                    // Update new password
                    String updateQuery = "UPDATE user_account SET password=? WHERE email=?";
                    ...
                    if (updated > 0) {
                        out.println("<script>alert('Password changed successfully!'); window.location='change_password.jsp';</script>");
                    } else {
